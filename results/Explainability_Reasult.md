...
📊 Classification Report (Test Set):
    ...
    Continue       0.96      0.99      0.97     48646
     Skip2P1       0.62      0.77      0.69      1311
        Next       0.94      0.79      0.86     10443
...
📊 Classification Report (Test Set):
    ...
    Continue       0.94      0.98      0.96     47619
     Skip2P1       0.54      0.74      0.62      1390
        Next       0.94      0.72      0.81     11791

    accuracy                           0.93     60800
   macro avg       0.81      0.81      0.80     60800
...
📊 Classification Report (Test Set):
    ...
    Continue       0.91      0.98      0.95     46631
     Skip2P1       0.38      0.61      0.47      1463
        Next       0.92      0.61      0.73     13106
...
✅ Real states loaded successfully!
   ...
   Action distribution (from real policy):
   {'Continue': np.int64(8153), 'Skip2P1': np.int64(221), 'Next': np.int64(1626)}
     Continue: 81.5%
     Skip2P1: 2.2%
     Next: 16.3%
...
⚠️  No blocking events table found
✅ Loaded test results for 23 scenarios
✅ Loaded 0 blocking event records
