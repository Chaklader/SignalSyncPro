import random 
from constants import simulationLimit, numberOfPrivateCarPerHour, minorToMajorTrafficRatio, straightTrafficRatio, turnRatio
...
for trafficLoad in [numberOfPrivateCarPerHour]: 
    ...
    for trafficLoad in [numberOfPrivateCarPerHour]:
        ...
        routes = open("privateCar.rou.xml", "w") 
        print("""<routes>
        ...
        for loopNumber in range(simulationLimit):
            ...
            if random.uniform(0,1) < acLoad: 
                print('    <vehicle id="%i" type="Volkswagen" route="1" depart="%i" departLane="free" departSpeed="random" />' % (vehNr, loopNumber), file=routes)
                vehNr += 1
            if random.uniform(0,1) < adLoad:
                print('    <vehicle id="%i" type="Volkswagen" route="2" depart="%i" departLane="free" departSpeed="random" />' % (vehNr, loopNumber), file=routes)
                vehNr += 1
            if random.uniform(0,1) < aeLoad:
                print('    <vehicle id="%i" type="Volkswagen" route="3" depart="%i" departLane="free" departSpeed="random" />' % (vehNr, loopNumber), file=routes)
                vehNr += 1
            if random.uniform(0,1) <afLoad:
                print('    <vehicle id="%i" type="Volkswagen" route="4" depart="%i" departLane="free" departSpeed="random" />' % (vehNr, loopNumber), file=routes)
                vehNr += 1
            if random.uniform(0, 1) <abLoad:
                print('    <vehicle id="%i" type="Volkswagen" route="5" depart="%i" departLane="free" departSpeed="random" />' % (vehNr, loopNumber), file=routes)
                vehNr += 1
            ...
            if random.uniform(0,1) < bfLoad:
                print('    <vehicle id="%i" type="Volkswagen" route="6" depart="%i" departLane="free" departSpeed="random" />' % (vehNr, loopNumber), file=routes)
                vehNr += 1
            if random.uniform(0,1) < beLoad:
                print('    <vehicle id="%i" type="Volkswagen" route="7" depart="%i" departLane="free" departSpeed="random" />' % (vehNr, loopNumber), file=routes)
                vehNr += 1
            if random.uniform(0,1) < baLoad:
                print('    <vehicle id="%i" type="Volkswagen" route="8" depart="%i" departLane="free" departSpeed="random" />' % (vehNr, loopNumber), file=routes)
                vehNr += 1
            if random.uniform(0,1) <  bdLoad:
                print('    <vehicle id="%i" type="Volkswagen" route="9" depart="%i" departLane="free" departSpeed="random" />' % (vehNr, loopNumber), file=routes)
                vehNr += 1
            if random.uniform(0, 1) < bcLoad:
                print('    <vehicle id="%i" type="Volkswagen" route="10" depart="%i" departLane="free" departSpeed="random" />' % (vehNr, loopNumber), file=routes)
                vehNr += 1

                
            if random.uniform(0,1) < dcLoad: 
                print('    <vehicle id="%i" type="Volkswagen" route="11" depart="%i" departLane="free" departSpeed="random" />' % (vehNr, loopNumber), file=routes)
                vehNr += 1
            if random.uniform(0,1) < daLoad:
                print('    <vehicle id="%i" type="Volkswagen" route="12" depart="%i" departLane="free" departSpeed="random" />' % (vehNr, loopNumber), file=routes)
                vehNr += 1
            if random.uniform(0,1) < dbLoad:
                print('    <vehicle id="%i" type="Volkswagen" route="13" depart="%i" departLane="free" departSpeed="random" />' % (vehNr, loopNumber), file=routes)
                vehNr += 1
            if random.uniform(0,1) < dfLoad:
                print('    <vehicle id="%i" type="Volkswagen" route="14" depart="%i" departLane="free" departSpeed="random" />' % (vehNr, loopNumber), file=routes)
                vehNr += 1
            if random.uniform(0,1) < deLoad:
                print('    <vehicle id="%i" type="Volkswagen" route="15" depart="%i" departLane="free" departSpeed="random" />' % (vehNr, loopNumber), file=routes)
                vehNr += 1
            ...
            if random.uniform(0,1) < caLoad: 
                print('    <vehicle id="%i" type="Volkswagen" route="16" depart="%i" departLane="free" departSpeed="random" />' % (vehNr, loopNumber), file=routes)
                vehNr += 1
            if random.uniform(0,1) < cdLoad:
                print('    <vehicle id="%i" type="Volkswagen" route="17" depart="%i" departLane="free" departSpeed="random" />' % (vehNr, loopNumber), file=routes)
                vehNr += 1
            if random.uniform(0,1) < cfLoad:
                print('    <vehicle id="%i" type="Volkswagen" route="18" depart="%i" departLane="free" departSpeed="random" />' % (vehNr,loopNumber), file=routes)
                vehNr += 1
            if random.uniform(0,1) < ceLoad:
                print('    <vehicle id="%i" type="Volkswagen" route="19" depart="%i" departLane="free" departSpeed="random" />' % (vehNr, loopNumber), file=routes)
                vehNr += 1
            if random.uniform(0,1) < cbLoad:
                print('    <vehicle id="%i" type="Volkswagen" route="20" depart="%i" departLane="free" departSpeed="random" />' % (vehNr, loopNumber), file=routes)
                vehNr += 1


                
            if random.uniform(0,1) < fbLoad: 
                print('    <vehicle id="%i" type="Volkswagen" route="21" depart="%i" departLane="free" departSpeed="random" />' % (vehNr, loopNumber), file=routes)
                vehNr += 1
            if random.uniform(0,1) < feLoad:
                print('    <vehicle id="%i" type="Volkswagen" route="22" depart="%i" departLane="free" departSpeed="random" />' % (vehNr, loopNumber), file=routes)
                vehNr += 1
            if random.uniform(0,1) < fdLoad:
                print('    <vehicle id="%i" type="Volkswagen" route="23" depart="%i" departLane="free" departSpeed="random" />' % (vehNr, loopNumber), file=routes)
                vehNr += 1
            if random.uniform(0,1) < fcLoad:
                print('    <vehicle id="%i" type="Volkswagen" route="24" depart="%i" departLane="free" departSpeed="random" />' % (vehNr, loopNumber), file=routes)
                vehNr += 1
            if random.uniform(0,1) < faLoad:
                print('    <vehicle id="%i" type="Volkswagen" route="25" depart="%i" departLane="free" departSpeed="random" />' % (vehNr, loopNumber), file=routes)
                vehNr += 1


                
            if random.uniform(0,1) < ebLoad: 
                print('    <vehicle id="%i" type="Volkswagen" route="26" depart="%i" departLane="free" departSpeed="random" />' % (vehNr, loopNumber), file=routes)
                vehNr += 1
            if random.uniform(0,1) < efLoad:
                print('    <vehicle id="%i" type="Volkswagen" route="27" depart="%i" departLane="free" departSpeed="random" />' % (vehNr, loopNumber), file=routes)
                vehNr += 1
            if random.uniform(0,1) < edLoad:
                print('    <vehicle id="%i" type="Volkswagen" route="28" depart="%i" departLane="free" departSpeed="random" />' % (vehNr, loopNumber), file=routes)
                vehNr += 1
            if random.uniform(0,1) <  ecLoad:
                print('    <vehicle id="%i" type="Volkswagen" route="29" depart="%i" departLane="free" departSpeed="random" />' % (vehNr, loopNumber), file=routes)
                vehNr += 1
            if random.uniform(0,1) < eaLoad:
                print('    <vehicle id="%i" type="Volkswagen" route="30" depart="%i" departLane="free" departSpeed="random" />' % (vehNr, loopNumber), file=routes)
                vehNr += 1
