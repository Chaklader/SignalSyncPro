...
for pedWE in [numberOfPedestrianPerHour]:
    ...
    for pedSN in [numberOfPedestrianPerHour]:
        ...
        routes = open(
            "../infrastructure/developed/common/routes/pedestrian.rou.xml", "w"
        )
        print(
            """<routes>
        ...
        for loopNumber in range(simulationLimit):
            if random.uniform(0, 1) < pedWE:
                print(
                    '    <vehicle id="%i" type="Berliner" route="a" depart="%i" departLane="free" departSpeed="random" />'
                    % (pedNr, loopNumber),
                    file=routes,
                )
                pedNr = pedNr + 1
            ...
            if random.uniform(0, 1) < pedEW:
                print(
                    '    <vehicle id="%i" type="Berliner" route="c" depart="%i" departLane="free" departSpeed="random" />'
                    % (pedNr, loopNumber),
                    file=routes,
                )
                pedNr = pedNr + 1
            ...
            if random.uniform(0, 1) < pedSN:
                print(
                    '    <vehicle id="%i" type="Berliner" route="e" depart="%i" departLane="free" departSpeed="random" />'
                    % (pedNr, loopNumber),
                    file=routes,
                )
                pedNr = pedNr + 1
            ...
            if random.uniform(0, 1) < pedNS:
                print(
                    '    <vehicle id="%i" type="Berliner" route="g" depart="%i" departLane="free" departSpeed="random" />'
                    % (pedNr, loopNumber),
                    file=routes,
                )
                pedNr = pedNr + 1
            ...
            if random.uniform(0, 1) < pedWE:
                print(
                    '    <vehicle id="%i" type="Berliner" route="i" depart="%i" departLane="free" departSpeed="random" />'
                    % (pedNr, loopNumber),
                    file=routes,
                )
                pedNr = pedNr + 1
            if random.uniform(0, 1) < pedEW:
                print(
                    '    <vehicle id="%i" type="Berliner" route="k" depart="%i" departLane="free" departSpeed="random" />'
                    % (pedNr, loopNumber),
                    file=routes,
                )
                pedNr = pedNr + 1
            ...
            if random.uniform(0, 1) < pedSN:
                print(
                    '    <vehicle id="%i" type="Berliner" route="m" depart="%i" departLane="free" departSpeed="random" />'
                    % (pedNr, loopNumber),
                    file=routes,
                )
                pedNr = pedNr + 1
            ...
            if random.uniform(0, 1) < pedNS:
                print(
                    '    <vehicle id="%i" type="Berliner" route="o" depart="%i" departLane="free" departSpeed="random" />'
                    % (pedNr, loopNumber),
                    file=routes,
                )
                pedNr = pedNr + 1
