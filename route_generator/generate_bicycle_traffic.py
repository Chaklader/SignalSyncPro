    ...
    for trafficLoad in [numberOfBiCyclePerHour]:
        ...
        for loopNumber in range(simulationLimit):
            if random.uniform(0, 1) < acLoad:
                print(
                    '    <vehicle id="%i" type="Raleigh" route="l" depart="%i" departLane="free" departSpeed="random" />'
                    % (bikeNr, loopNumber),
                    file=routes,
                )
                bikeNr = bikeNr + 1
            if random.uniform(0, 1) < adLoad:
                print(
                    '    <vehicle id="%i" type="Raleigh" route="ll" depart="%i" departLane="free" departSpeed="random" />'
                    % (bikeNr, loopNumber),
                    file=routes,
                )
                bikeNr += 1
            if random.uniform(0, 1) < aeLoad:
                print(
                    '    <vehicle id="%i" type="Raleigh" route="lll" depart="%i" departLane="free" departSpeed="random" />'
                    % (bikeNr, loopNumber),
                    file=routes,
                )
                bikeNr += 1
            ...
            if random.uniform(0, 1) < afLoad:
                print(
                    '    <vehicle id="%i" type="Raleigh" route="lV" depart="%i" departLane="free" departSpeed="random" />'
                    % (bikeNr, loopNumber),
                    file=routes,
                )
                bikeNr += 1
            ...
            if random.uniform(0, 1) < abLoad:
                print(
                    '    <vehicle id="%i" type="Raleigh" route="V" depart="%i" departLane="free" departSpeed="random" />'
                    % (bikeNr, loopNumber),
                    file=routes,
                )
                bikeNr += 1
            ...
            if random.uniform(0, 1) < bfLoad:  # Poisson distribution
                print(
                    '    <vehicle id="%i" type="Raleigh" route="Vl" depart="%i" departLane="free" departSpeed="random" />'
                    % (bikeNr, loopNumber),
                    file=routes,
                )
                bikeNr += 1
            if random.uniform(0, 1) < beLoad:
                print(
                    '    <vehicle id="%i" type="Raleigh" route="Vll" depart="%i" departLane="free" departSpeed="random" />'
                    % (bikeNr, loopNumber),
                    file=routes,
                )
                bikeNr += 1
            if random.uniform(0, 1) < baLoad:
                print(
                    '    <vehicle id="%i" type="Raleigh" route="Vlll" depart="%i" departLane="free" departSpeed="random" />'
                    % (bikeNr, loopNumber),
                    file=routes,
                )
                bikeNr += 1
            if random.uniform(0, 1) < bdLoad:
                print(
                    '    <vehicle id="%i" type="Raleigh" route="lX" depart="%i" departLane="free" departSpeed="random" />'
                    % (bikeNr, loopNumber),
                    file=routes,
                )
                bikeNr += 1
            if random.uniform(0, 1) < bcLoad:
                print(
                    '    <vehicle id="%i" type="Raleigh" route="X" depart="%i" departLane="free" departSpeed="random" />'
                    % (bikeNr, loopNumber),
                    file=routes,
                )
                bikeNr += 1
            ...
            if random.uniform(0, 1) < dcLoad:  # Poisson distribution
                print(
                    '    <vehicle id="%i" type="Raleigh" route="Xl" depart="%i" departLane="free" departSpeed="random" />'
                    % (bikeNr, loopNumber),
                    file=routes,
                )
                bikeNr += 1
            if random.uniform(0, 1) < daLoad:
                print(
                    '    <vehicle id="%i" type="Raleigh" route="Xll" depart="%i" departLane="free" departSpeed="random" />'
                    % (bikeNr, loopNumber),
                    file=routes,
                )
                bikeNr += 1
            if random.uniform(0, 1) < dbLoad:
                print(
                    '    <vehicle id="%i" type="Raleigh" route="Xlll" depart="%i" departLane="free" departSpeed="random" />'
                    % (bikeNr, loopNumber),
                    file=routes,
                )
                bikeNr += 1
            ...
            if random.uniform(0, 1) < dfLoad:
                print(
                    '    <vehicle id="%i" type="Raleigh" route="XlV" depart="%i" departLane="free" departSpeed="random" />'
                    % (bikeNr, loopNumber),
                    file=routes,
                )
                bikeNr += 1
            ...
            if random.uniform(0, 1) < deLoad:
                print(
                    '    <vehicle id="%i" type="Raleigh" route="XV" depart="%i" departLane="free" departSpeed="random" />'
                    % (bikeNr, loopNumber),
                    file=routes,
                )
                bikeNr += 1
            ...
            if random.uniform(0, 1) < caLoad:  # Poisson distribution
                print(
                    '    <vehicle id="%i" type="Raleigh" route="XVl" depart="%i" departLane="free" departSpeed="random" />'
                    % (bikeNr, loopNumber),
                    file=routes,
                )
                bikeNr += 1
            if random.uniform(0, 1) < cdLoad:
                print(
                    '    <vehicle id="%i" type="Raleigh" route="XVll" depart="%i" departLane="free" departSpeed="random" />'
                    % (bikeNr, loopNumber),
                    file=routes,
                )
                bikeNr += 1
            if random.uniform(0, 1) < cfLoad:
                print(
                    '    <vehicle id="%i" type="Raleigh" route="XVlll" depart="%i" departLane="free" departSpeed="random" />'
                    % (bikeNr, loopNumber),
                    file=routes,
                )
                bikeNr += 1
            if random.uniform(0, 1) < ceLoad:
                print(
                    '    <vehicle id="%i" type="Raleigh" route="XlX" depart="%i" departLane="free" departSpeed="random" />'
                    % (bikeNr, loopNumber),
                    file=routes,
                )
                bikeNr += 1
            if random.uniform(0, 1) < cbLoad:
                print(
                    '    <vehicle id="%i" type="Raleigh" route="XX" depart="%i" departLane="free" departSpeed="random" />'
                    % (bikeNr, loopNumber),
                    file=routes,
                )
                bikeNr += 1
            ...
            if random.uniform(0, 1) < fbLoad:  # Poisson distribution
                print(
                    '    <vehicle id="%i" type="Raleigh" route="XXl" depart="%i" departLane="free" departSpeed="random" />'
                    % (bikeNr, loopNumber),
                    file=routes,
                )
                bikeNr += 1
            if random.uniform(0, 1) < feLoad:
                print(
                    '    <vehicle id="%i" type="Raleigh" route="XXll" depart="%i" departLane="free" departSpeed="random" />'
                    % (bikeNr, loopNumber),
                    file=routes,
                )
                bikeNr += 1
            if random.uniform(0, 1) < fdLoad:
                print(
                    '    <vehicle id="%i" type="Raleigh" route="XXlll" depart="%i" departLane="free" departSpeed="random" />'
                    % (bikeNr, loopNumber),
                    file=routes,
                )
                bikeNr += 1
            if random.uniform(0, 1) < fcLoad:
                print(
                    '    <vehicle id="%i" type="Raleigh" route="XXlV" depart="%i" departLane="free" departSpeed="random" />'
                    % (bikeNr, loopNumber),
                    file=routes,
                )
                bikeNr += 1
            if random.uniform(0, 1) < faLoad:
                print(
                    '    <vehicle id="%i" type="Raleigh" route="XXV" depart="%i" departLane="free" departSpeed="random" />'
                    % (bikeNr, loopNumber),
                    file=routes,
                )
                bikeNr += 1
            ...
            if random.uniform(0, 1) < ebLoad:  # Poisson distribution
                print(
                    '    <vehicle id="%i" type="Raleigh" route="XXVl" depart="%i" departLane="free" departSpeed="random" />'
                    % (bikeNr, loopNumber),
                    file=routes,
                )
                bikeNr += 1
            if random.uniform(0, 1) < efLoad:
                print(
                    '    <vehicle id="%i" type="Raleigh" route="XXVll" depart="%i" departLane="free" departSpeed="random" />'
                    % (bikeNr, loopNumber),
                    file=routes,
                )
                bikeNr += 1
            if random.uniform(0, 1) < edLoad:
                print(
                    '    <vehicle id="%i" type="Raleigh" route="XXVlll" depart="%i" departLane="free" departSpeed="random" />'
                    % (bikeNr, loopNumber),
                    file=routes,
                )
                bikeNr += 1
            if random.uniform(0, 1) < ecLoad:
                print(
                    '    <vehicle id="%i" type="Raleigh" route="XXlX" depart="%i" departLane="free" departSpeed="random" />'
                    % (bikeNr, loopNumber),
                    file=routes,
                )
                bikeNr += 1
            if random.uniform(0, 1) < eaLoad:
                print(
                    '    <vehicle id="%i" type="Raleigh" route="XXX" depart="%i" departLane="free" departSpeed="random" />'
                    % (bikeNr, loopNumber),
                    file=routes,
                )
                bikeNr += 1
