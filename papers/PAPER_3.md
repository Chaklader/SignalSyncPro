...
The 22s offset in the 2-TLS corridor **cannot guarantee** green in all cases - it relies on TLS-2 being close to P1
naturally, or having different phase durations.
